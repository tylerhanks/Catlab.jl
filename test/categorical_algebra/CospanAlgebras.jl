...
OpenContinuousOpt = DecoratedCospanAlgebra{Open{Optimizer}}(ContinuousOpt())
OpenDiscreteOpt = DecoratedCospanAlgebra{Open{Optimizer}}(DiscreteOpt())
